...
func (o *Tag) UserTagMaps(mods ...qm.QueryMod) userTagMapQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_tag_maps\".\"tag_id\"=?", o.ID),
	)
...
func (tagL) LoadUserTagMaps(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(qm.From(`user_tag_maps`), qm.WhereIn(`user_tag_maps.tag_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Tag) AddUserTagMaps(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserTagMap) error {
	var err error
